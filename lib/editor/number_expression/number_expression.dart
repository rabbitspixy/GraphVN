...
import 'package:graph_vn/editor/number_expression/random_number_expression.dart';
...
abstract class NumberExpression {
  ...
  factory NumberExpression.fromProto(NumberExpressionProto proto) {
    return switch(proto.whichType()) {
      ...
      NumberExpressionProto_Type.randomNumberExpression => RandomNumberExpression.fromProto(proto.randomNumberExpression),
...
enum NumberExpressionType {
  ...
  randomValue(type: RandomNumberExpression, create: RandomNumberExpression.new, title: 'Random'),
  ;
